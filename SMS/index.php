...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/A11.jpg);" data-stellar-background-ratio="0.5">
		  <div class="home-slider owl-carousel">
	      <div class="slider-item js-fullheight">
	      	<div class="overlay"></div>
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/a20.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="mt-5">
		          		<span class="subheading">CREATIVITY</span>
			            <h1 class="mb-4">Get Attractive Look</h1>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/A5.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="mt-5">
		          		<span class="subheading">Natural Beauty</span>
			            <h1 class="mb-4">Fashion Salon</h1>
    ...
    <section class="ftco-section ftco-no-pt ftco-booking">
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              {
              ?>
		                       <option value="<?php echo $row['ServiceName'];?>"><?php echo $row['ServiceName'];?>...RS.<td><?php  echo $row['Cost'];?></td></option>
		                       <?php } ?> 
		                      </select>
		                    </div>
					            </div>
				          ...
				          <div class="form-group">
			              <input type="submit" name="submit" value="Take an Appointment" class="btn btn-primary">
			            </div>
			          </form>
		          </div>
						</div>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/a0.jpg);">
						</div>
					</div>
    		</div>
    	</div>
